...
//        let ticker = TickIndefinite(current: current, increment: increment, interval: 86_400,
//          ticktime: timeTo1800, server_time: server_time)
//        return ticker
//    }
}
...
//    init(current: Int, maximum: Int, increment: Int, interval: Seconds,
//      ticktime: Seconds, fulltime: Seconds, server_time: UnixTime) {
//        self.maximum = maximum
//        self.fulltime = fulltime
//        super.init(current: current, increment: increment,
//          interval: interval, ticktime: ticktime, server_time: server_time)
//    }
}
