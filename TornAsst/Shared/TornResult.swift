...
struct ErrorResult: Codable { // TODO prune this out of use; moved to Activity.ErrorResponse
    var code: Int
    var error: String
...
//        default:
//            return "Unknown error lookup"
//        }
//    }
    
    static var `default` = ErrorResult(code: 13, error: "A Placeholder error message")
